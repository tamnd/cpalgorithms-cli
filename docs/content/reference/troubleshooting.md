...
Most of these come down to network reality or how cpalgorithms serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cpalgorithms rate-limits like any public site. cpa already paces
...
Where a surface is gated, cpa reads a cookie or token you supply
...
`cpa`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cpa actually did
